...
muscle_extent = [3.843586, 3.843586, 38.820218]  # [cm, cm, cm] - Vol=573.5 cm^3, ratio=10.1000
...
rho = 10.534   ## [1e-4 kg/cm^3] density
...
Am = 450                          # surface area to volume ratio [cm^-1]
...
diffusion_prefactor = 3.828 / (450 * 0.58)  # Conductivity / (Am * Cm)
