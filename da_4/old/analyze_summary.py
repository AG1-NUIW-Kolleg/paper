...
# Load CSV
df = pd.read_csv('/Users/canis/Library/CloudStorage/OneDrive-Persönlich/work/SdV/natwissKolleg/results/final_results/results_for_paper/da_4/only_summary/all_results_summary_new3.csv')
