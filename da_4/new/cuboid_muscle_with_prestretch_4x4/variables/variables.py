...
n_elements_muscle = [4, 4, 10] # linear elements. each qudaratic element uses the combined nodes of 8 linear elements, changes: 8 to 4, 20 to 10
n_points_whole_fiber = 30 # changes: 60 to 30
n_fibers_x = 3 # changes: 6 to 3
n_fibers_y = 3 # changes: 6 to 3
