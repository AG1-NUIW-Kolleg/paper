...
prestretch_force =  0.0        # [N]  (-30 also works)
# constant_body_force = (0,0,-9.81e-4)   # [cm/ms^2], gravity constant for the body force

# timing parameters
# -----------------
dt_3D = 0.1
dt_0D = 0.5e-3                        # [ms] timestep wi dth of ODEs
...
muscle_extent = [4.180659, 4.180659, 42.224655]  # [cm, cm, cm] - Vol=738.0 cm^3, ratio=10.1000
...
rho = 10.575                    # [1e-4 kg/cm^3] density of the muscle
